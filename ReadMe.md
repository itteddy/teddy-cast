Red Hat Fuse on EAP Spring XML Web Application : teddy-cast
==============================================
...
http://localhost:8080/teddy-cast/webjars/swagger-ui/3.23.5/index.html?url=/teddy-cast/camel/api-docs

For testing

    curl http://localhost:8080/teddy-cast/camel/api-docs
    curl http://localhost:8080/teddy-cast/camel/ping
